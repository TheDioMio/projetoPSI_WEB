...
<div class="container">
    <div class="row g-4">
        ...
        <!-- LEFT: FORM (teu bloco atual, só embrulhei) -->
        <div class="col-lg-8">
            <div class="bg-light rounded p-4 p-sm-5">

                <h3>Obrigado pelo seu interesse!</h3>
                <p>O preenchimento deste formulário é o primeiro passo para a adoção.</p>
        ...
        <div class="col-lg-4">
            <div class="position-sticky" style="top:2rem;">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">Resumo do animal</small>
                            </div>
                        ...
                        <ul class="list-unstyled small mb-0">
                            <li class="mb-2"><span class="text-muted">Raça:</span> <strong><?= Html::encode($animal->breed?->description ?? '—') ?></strong></li>
                            <li class="mb-2"><span class="text-muted">Idade:</span> <strong><?= Html::encode($animal->age?->description ?? '—') ?></strong></li>
                            <li class="mb-2"><span class="text-muted">Porte:</span> <strong><?= Html::encode($animal->size->description ?? '—') ?></strong></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <h3 class="h6 mb-3">Dicas para uma boa candidatura</h3>
                        <ul class="small text-muted mb-0">
                            <li>Explique a sua rotina e tempo disponível.</li>
                            <li>Conte-nos sobre a casa e regras do senhorio.</li>
                            <li>Mostre que está preparado para custos e imprevistos.</li>
                        </ul>
                    </div>
                </div>
